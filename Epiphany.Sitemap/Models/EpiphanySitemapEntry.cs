namespace Epiphany.Sitemap.Models
{
    ...
    public class EpiphanySitemapEntry
    {
        ...
        ///     server requires it. This value must be less than 2,048 characters.
        /// </summary>
        public string Loc { get; set; }


        /// <summary>
        ///     The date of last modification of the file. This date should be in W3C Datetime format. This format allows you to
        ...
        ///     not affect how your pages are compared to pages on other sites—it only lets the search engines know which pages you
